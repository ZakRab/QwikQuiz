...
export const TestStore = writable([
	...
	new Test(
		'Physics', 2, new Tag("Physics", 2, "green"),
		[
	...
	new Test(
		'Chemistry', 3, new Tag("Chemistry", 3, "yellow"),
		[
	...
	new Test(
		'History', 4, new Tag("History", 4, "purple"),
		[
	...
	new Test(
		'Chemistry Review', 6, new Tag("Chemistry", 6, "yellow"),
		[
